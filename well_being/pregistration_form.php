...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="ion/registration.php">Register</a>
        </nav>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="info">
                ...
                <label for="mobile">Mobile Number
                    <input type="text" class="box" placeholder="Mobile Number" name="mobile" id="mobile" /></label>

                <label for="nid">National ID
                    <input type="text" class="box" placeholder="National ID" name="nid" id="nid" /></label>

                <label for="bcn">Birth Certificate No
                    <input type="text" class="box" placeholder="Birth Certificate No" name="bcn" id="bcn"
                        required /></label>
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$bcnquery = mysqli_query($con, "select * from  patient_registration where bcn='$bcn'");
		
		$bcncount = mysqli_num_rows($bcnquery);
		

		if($bcncount > 0){
            echo ("Birth certificate no already exists.");  
        } 
        else{
            if($_POST['npassword'] === $_POST['cpassword']){
                ...
                $insertquery = mysqli_query($con, "insert into patient_registration(fname,lname,patientid,email,mobile,nid,bcn,dob,gender,picture,district,thana,area,buildingno,password, blood)values('$fname', '$lname', '$patientid', '$email', '$mobile', '$nid', '$bcn', '$dob', '$gender', '$image', '$district', '$thana', '$area', '$buildingno', '$password', '$blood')");
